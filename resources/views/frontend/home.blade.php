        ...
        <div class="grid grid-cols-12 lg:gap-12">
          <div
            ...
            <div class="flex items-center justify-between">
              ...
              <p class="text-base text-white/60">{{ number_format($jobs->count())}} {{ str('Result')->plural($jobs->count())}} Found</p>
            </div>
            <!-- /Section Header -->
            <!-- Job Listings -->
            <div>
                ...
                <div
                  ...
                  <div>
                    ...
                    <h6
                      ...
                      <a href="{{ route('frontend.job_details', $job->id)}}">{{ $job->title}}/a>
                    </h6>
            ...
            <!-- /Job Card -->
              ...
              <h4 class="my-4 text-center text-xl font-semibold text-white/80">No job posted yet. Come back later!</h4>
